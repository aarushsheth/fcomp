...
// Module: Fcomp.MaximalDegree
// Imports: Init Fcomp.Terms Fcomp.Types Fcomp.Context Fcomp.Beta Fcomp.Substitution Fcomp.Degree Fcomp.NormSubstitution
#include <lean/lean.h>
...
lean_object* initialize_Fcomp_NormSubstitution(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Fcomp_MaximalDegree(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Fcomp_NormSubstitution(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
