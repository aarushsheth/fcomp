...
// Module: Fcomp.Strategies
// Imports: Init Fcomp.Terms Fcomp.Types Fcomp.Context Fcomp.Beta Fcomp.Eta
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Fcomp_Strategies(uint8_t builtin, lean_object* w) {
lean_object * res;
